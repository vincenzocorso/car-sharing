...
import it.vincenzocorso.carsharing.rentservice.api.RentCreatedEvent;
import it.vincenzocorso.carsharing.rentservice.api.RentStateTransitionEvent;
...
public class Rent {
	...
	public boolean equals(Object o) {
		...
		Rent rent = (Rent) o;
		return Objects.equals(this.id, rent.id) && this.details.equals(rent.details);
	}

	@Override
	public int hashCode() {
		return Objects.hash(this.id, this.details);
	}
}
