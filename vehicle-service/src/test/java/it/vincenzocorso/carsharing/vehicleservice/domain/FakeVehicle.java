...
public class FakeVehicle {
    public static final String VEHICLE_ID = "36568a0e-9b09-442e-ad6a-a63539f8466a";
    public static final String LICENSE_PLATE = "AB123FG";
    public static final String VEHICLE_MODEL_ID = "714fc19b-c983-48ec-af1d-17ca60797b0a";
    ...
    public static final Vehicle VEHICLE = new Vehicle(VEHICLE_ID, LICENSE_PLATE, VEHICLE_MODEL, VEHICLE_STATUS, VEHICLE_STATE, UNLOCK_CODE);
    ...
    public static Vehicle vehicleWithUnlockCode(VehicleState state, String unlockCode) {
        return new Vehicle(VEHICLE_ID, LICENSE_PLATE, VEHICLE_MODEL, VEHICLE_STATUS, state, unlockCode);
    }

    public static Vehicle vehicleInState(VehicleState state) {
        return new Vehicle(VEHICLE_ID, LICENSE_PLATE, VEHICLE_MODEL, VEHICLE_STATUS, state, UNLOCK_CODE);
    }
    ...
    public static void assertEqualsWithVehicle(Vehicle actualVehicle) {
        ...
        assertEqualsWithVehicleModel(actualVehicle.getModel());
